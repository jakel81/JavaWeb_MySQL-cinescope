...
public class FilmDAO {
    ...
    public static String getFilmAutoCompletion() {
        ...
        JSONArray tableauJSON = new JSONArray();
        try {
            String lsSQL = "select TITRE_film from film";
    ...
    public static List<FilmRecherche> getFilmsRecherche(String Recherche) {
        ...
        Connection lcn = Connexion.seConnecter("172.26.55.55", "3306", "p", "b", "cinescope2014");
        //Connection lcn = Connexion.seConnecter("172.26.55.55", "cinescope2017", "3306", "p", "b");
...
//                    + " group by film.titre_film";
    ...
    public static JSONArray selectByBeginningOfTitle(String psChaine) {
        JSONArray tableauJSON = new JSONArray();
        ...
        try {
            ...
            while (lrs.next()) {
                ...
                ObjetJSON.put("titre", lrs.getString(2));
