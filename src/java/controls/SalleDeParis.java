 ...
 * @author Jo
 */
@WebServlet(name = "SalleDeParis", urlPatterns = {"/SalleDeParis"})
public class SalleDeParis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://172.26.55.55:3306/cinescope2014", "p", "b");

            List<entities.Metro> liste = SallesDeParisDAO.selectAll(con);
